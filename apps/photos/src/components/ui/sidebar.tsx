  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "w-(--sidebar-width) relative bg-transparent transition-[width] duration-200 ease-out",
      ...
      <div
        ...
        className={cn(
          "w-(--sidebar-width) linear fixed inset-y-0 z-10 hidden h-svh transition-[left,right,width] duration-200 ease-out md:flex",
          side === "left"
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        "text-sidebar-foreground/70 ring-sidebar-ring outline-hidden flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium transition-[margin,opacity] duration-200 ease-out focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
